...
<head>
	...
	<%@include file="workItemList.js" %>
	<script type="text/javascript">
		$(window).resize(function () {
			$("#workItemlTale").bootstrapTable('resetView');
		});
	</script>
</head>
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="workItem" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="attence:item:exportWorkData">
	...
	<!-- 表格 -->
	<table id="workItemlTale"   data-toolbar="#toolbar"></table>
