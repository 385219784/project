...
<head>
	...
	<%@include file="projectCollectList.js" %>
	...
	<script type="text/javascript">
		...
		$(window).resize(function () {
			$("#projectCollectTable").bootstrapTable('resetView');
		});
	</script>
</head>
<body>
	...
	<!-- <div class="panel-heading">
		<h3 class="panel-title">工作情况汇总</h3>
	</div> -->
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			...
			<div class="col-xs-6 col-sm-4 col-md-3">
				...
				<div class="col-xs-12">
					<div class='input-group date' id='startDate' >
	                   <input type='text'  name="startDate" class="form-control input-sm"  />
			 ...
			 <div class="col-xs-6 col-sm-4 col-md-3">
				...
				<div class="col-xs-12">
					<div class='input-group date' id='endDate' >
	                   <input type='text'  name="endDate" class="form-control input-sm"  />
	                   <span class="input-group-addon">
	                       <span class="glyphicon glyphicon-calendar"></span>
	                   </span>
		            </div>	
			...
			<div class="col-xs-6 col-sm-4 col-md-3">
				...
				<form:input path="specialtyUser" htmlEscape="false" maxlength="64"  class=" form-control input-sm"/>
			</div>
			 <%-- <div class="col-xs-6 col-sm-4 col-md-3">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="project:projectCollect:export">
				...
				<!-- 项目状态 -->
			<span id="proStateInfo" tableId="#projectCollectTable"></span>
		    </div>
		
	<!-- 表格 -->
	<table id="projectCollectTable"   data-toolbar="#toolbar"></table>
