	...
	<body>
		...
		<div class="row">
			<div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
				<img style="height:125px; weight:360px;" src="${ctxStatic}/common/images/flat-avatar1.png"  />
				<h1>市政院项目管理系统</h1>
				<sys:message content="${message}" showType="1"/>
				<form id="loginForm" role="form" action="${ctx}/login" method="post">
					<div class="form-content">
						<div class="form-group">
							<input type="text" autocomplete="off" id="username" name="username" class="form-control input-underline input-lg required"  value="" placeholder="用户名">
						</div>
