				  ...
				  //请求方法
				    ...
				    }, 
				    {
				        ...
				        formatter:function(value, row , index){
				        	if(value != null && value != ''){
					        	if(value.length > 10){
						        	return "<abbr title='"+ value +"' class='initialism'><a style='color:#676a6c;'>"+ formatterValue(value,10) +"</a></abbr>";
					        	}
				        	}
				        	return value;
				         }
				    }, 
				    {
				        ...
				        formatter:function(value, row , index){
				        	if(value != null && value != ''){
					        	if(value.length > 20){
						        	return "<abbr title='"+ value +"' class='initialism'><a style='color:#676a6c;'>"+ formatterValue(value,20) +"</a></abbr>";
					        	}
				        	}
				        	return value;
				         }
