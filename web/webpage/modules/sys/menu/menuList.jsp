			 ...
			 <div class="row">
			    ...
			    <div id="toolbar" class="treetable-bar">
			    	<shiro:hasPermission name="sys:menu:add">
						<a id="add" class="btn btn-primary" onclick="jp.openDialog('新建菜单2', '${ctx}/sys/menu/form?parent.id={menu.id}','800px', '500px', $treeTable)"><i class="glyphicon glyphicon-plus"></i> 新建菜单3</a><!-- 增加按钮 -->
					</shiro:hasPermission>
