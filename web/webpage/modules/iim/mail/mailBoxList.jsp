            ...
            <div class="col-sm-9 animated fadeInRight">
                <div class="mail-box-header">
                    ...
                    <div class="mail-tools tooltip-demo m-t-md">
                        ...
                        <button class="btn btn-default  " data-toggle="tooltip" data-placement="top" title="标为已读"  onclick="markAlRead()"  ><i class="fa fa-eye"></i>标为已读
                        </button>
                        <button class="btn btn-default " data-toggle="tooltip" data-placement="top" title="标为重要"   onclick="markImptant()"><i class="fa fa-heart"></i>标记重要
                        </button>
                        
                          <button class="btn btn-default " data-toggle="tooltip" data-placement="top" title="标为重要"   onclick="cancleImptant()"><i class="fa fa-exclamation"></i>取消重要
                        </button>
                ...
                <div class="mail-box">
                    ...
                    <table id="contentTable" class="table table-hover">
                        ...
                        <tbody>
                        	...
                        	<c:choose>
   							 <c:when test="${mailBox.isImportant =='1'}">
      								<tr   class="Important">  
   							 </c:when>
   							 <c:otherwise>
      							<tr>
    ...
    <script>
	   ...
	   function search(){//查询，页码清零
		...
		function markAlRead(){
			  ...
			  jp.post("${ctx}/iim/mailBox/markAlRead","ids="+ids,
					  function(data){
						if(data.success){
							jp.success(data.msg);
							sortOrRefresh();
		...
		function markImptant(){
			  ...
			  jp.post("${ctx}/iim/mailBox/markImptant","ids="+ids,
					  function(data){
						if(data.success){
							jp.success(data.msg);
							sortOrRefresh();
		...
		function cancleImptant(){
			  ...
			  jp.post("${ctx}/iim/mailBox/cancleImptant","ids="+ids,
					  function(data){
						if(data.success){
							jp.success(data.msg);
							sortOrRefresh();
