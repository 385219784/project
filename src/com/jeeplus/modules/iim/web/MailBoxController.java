...
public class MailBoxController extends BaseController {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "markAlRead")
	public AjaxJson markAlRead(String ids) throws Exception{
		AjaxJson j = new AjaxJson();
		try {
			String idArray[] =ids.split(",");
			for(String id : idArray){
				mailBoxService.markAlRead(id);
			}
			j.setSuccess(true);
			j.setMsg("标记已读成功!");
			return j;
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "markImptant")
	public AjaxJson markImptant(String ids) throws Exception{
		AjaxJson j = new AjaxJson();
		try {
			String idArray[] =ids.split(",");
			for(String id : idArray){
				mailBoxService.markImptant(id);
			}
			j.setSuccess(true);
			j.setMsg("标记重要成功!");
			return j;
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "cancleImptant")
	public AjaxJson cancleImptant(String ids) throws Exception{
		AjaxJson j = new AjaxJson();
		try {
			String idArray[] =ids.split(",");
			for(String id : idArray){
				mailBoxService.cancleImptant(id);
			}
			j.setSuccess(true);
			j.setMsg("取消重要成功!");
			return j;
