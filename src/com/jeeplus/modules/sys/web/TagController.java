...
public class TagController extends BaseController {
	...
	public String treeselect(HttpServletRequest request, Model model) {
		...
		model.addAttribute("parentId", request.getParameter("parentId"));	//参数
	 ...
	 */
	@RequiresPermissions("user")
	@RequestMapping(value = "progridselect")
	public String progridselect(String url, String fieldLabels, String fieldKeys, String searchLabels, String searchKeys, String isMultiSelected, HttpServletRequest request, HttpServletResponse response, Model model) {
		try {
			fieldLabels = URLDecoder.decode(fieldLabels, "UTF-8");
			fieldKeys = URLDecoder.decode(fieldKeys, "UTF-8");
			searchLabels = URLDecoder.decode(searchLabels, "UTF-8");
		...
		model.addAttribute("searchLabels", searchLabels.split("\\|"));
		model.addAttribute("searchKeys", searchKeys.split("\\|"));
		return "modules/common/progridselect";
	}
