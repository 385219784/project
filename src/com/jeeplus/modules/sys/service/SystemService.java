...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public User getUserByWorkerNo(String loginName) {
		return UserUtils.getByWorkerNo(loginName);
	}
...
//			systemRealm.clearAllCachedAuthorizationInfo();
		...
		// 增加用户专业信息
		List<Specialty> specialtyList = user.getSpecialtyList();
		// 删除用户专业信息
		userMapper.deleteSpecialty(user.getId());
		for(Specialty specialty : specialtyList){
			specialty.setIsNewRecord(true);
			specialty.preInsert();
			specialty.setUserSpecialtyId(IdGen.uuid());
			specialty.setUser(user);
			specialty.setDelFlag(Specialty.DEL_FLAG_NORMAL);
			//添加用户专业信息
			userMapper.addSpecialty(specialty);
		}
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<User> findAllUser(User user){
		return userMapper.findAllList(user);
	}
	 ...
	 * @return
	 */
	public List<Specialty> getSpecialtyList(String userId) {
		return userMapper.getSpecialtyList(userId);
	}
}
