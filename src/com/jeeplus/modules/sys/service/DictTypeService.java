...
public class DictTypeService extends CrudService<DictTypeMapper, DictType> {
	...
	public Page<DictValue> findPages(Page<DictValue> page, DictValue dictValue) {
		dataRuleFilter(dictValue);
		dictValue.setPage(page);
		return page.setList(dictValueMapper.findList(dictValue));
	}
	...
	public List<DictValue> getDictValues(String parentId) {
		return dictValueMapper.getDictValues(parentId);
	}
	...
	public String getLabel(String id) {
		return dictValueMapper.getLabel(id);
	}
	 ...
	 * @return
	 */
	public List<DictValue> getSonTypes(Map<String, Object> paramMap) {
		//根据父value和type查找父id
		String parentId = dictValueMapper.getParentId(paramMap);
		System.out.println("parentId="+parentId);
		paramMap.put("parentId", parentId);
		//根据父id和type查找下级字典
		return dictValueMapper.getSonTypes(paramMap);
	}
